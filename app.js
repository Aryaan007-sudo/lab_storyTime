...
function moreAboutKaren(parents,noOfSiblings,isNuclearFamily){
    return (typeof(parents + noOfSiblings+ isNuclearFamily))
...
function sweetTooth(totalNoSweets,sweetsConsumedByKaren,sweetsConsumedInNMeters,metersToTravel){
    let a = totalNoSweets-sweetsConsumedByKaren;
...
function aDifficultChoice(choice){
   //console.log(choice)
   let choicesArr=["","Take her daughter to a doctor",
